// lib/presentation/screens/admin/catalog_admin_screen.dart
...
class CatalogAdminScreen extends ConsumerStatefulWidget {
  const CatalogAdminScreen({super.key});

  @override
  ConsumerState<CatalogAdminScreen> createState() => _CatalogAdminScreenState();
}

class _CatalogAdminScreenState extends ConsumerState<CatalogAdminScreen> with SingleTickerProviderStateMixin {
